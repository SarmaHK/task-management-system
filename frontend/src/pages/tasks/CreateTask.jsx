    ...
    <DashboardLayout>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-visible">
          {/* Gradient header */}
          <div className="bg-gradient-to-r from-[#0D5A60] to-[#118B95] px-6 sm:px-8 py-6 text-white rounded-t-2xl">
        ...
        {/* Tips card */}
        <div className="mt-5 bg-[#E6F5F6] border border-[#BEE3E6] rounded-2xl px-5 py-4 flex gap-3">
          <div className="text-[#3DB0B8] mt-0.5 flex-shrink-0">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <div>
            <p className="text-[12.5px] font-bold text-[#0D5A60] mb-0.5">Pro Tip</p>
            <p className="text-[12px] text-[#118B95]/80 leading-relaxed">
